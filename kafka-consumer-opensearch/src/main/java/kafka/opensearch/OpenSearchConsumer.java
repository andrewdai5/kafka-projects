    ...
    public static void main(String[] args) throws IOException {
        ...
        try(openSearchClient; consumer){
            ...
            while(true) {
                ...
                // create bulk to send request to openSearch in batches
                ...
                if (bulkRequest.numberOfActions() > 0){
                    ...
                    // Add some delay to make sure request are sent successfully before committing
                    try {
                        Thread.sleep(1000);
